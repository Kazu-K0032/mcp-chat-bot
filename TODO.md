...
- [x] **7-1.** GitHub リポジトリを Vercel にインポートする
- [x] **7-2.** Vercel ダッシュボードで `ANTHROPIC_API_KEY` 環境変数を設定する
- [x] **7-3.** デプロイして本番 URL で動作確認する
- [x] **7-4.** README.md を作成し、プロジェクト説明・起動方法・デプロイ方法を記載する
